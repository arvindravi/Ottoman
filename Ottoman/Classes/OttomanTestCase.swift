...
/// The default contexts that OttomanTestCase conforms to, to provide lots of helpful functions to make it highly possible
...
///
/// OttomanTestCase will automatically launch and terminate your app as part of setUp and tearDown. You can
/// delay launch and termination to perform some additional work, by overriding preLaunchSetup and preTerminationTearDown.
///
/// Finally, OttomanTestCase will help you by creating attachments when tests failed, with the last known Scenario and Step
/// which are found in the xcresult bundle created as part of the test run (usually in Derived Data).
open class OttomanTestCase: XCTestCase, DefaultContexts {
